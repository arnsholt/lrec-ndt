    ...
    \begin{column}{0.20\textwidth}
        ...
        \begin{center}
            \begin{tikzpicture}
                ...
                \draw (-5.2, -8.2) node (medat_target) {} ;
            \end{tikzpicture}
        \end{center}
    ...
    \begin{column}{0.45\textwidth}
        ...
        \begin{columns}[T]
            ...
            \begin{column}{0.1\textwidth}
                % Shenanigans to force other two column outwards.
            \end{column}
...
\begin{tikzpicture}[overlay]
    \draw[thick] (medat_from) .. controls +(2,0) and +(-5,-5) .. (medat_target);
    \draw[thick] (utenat_from) .. controls +(20,0) and +(0,-5) .. (utenat_target);
    \draw[thick] (coord_from) .. controls +(20,0) and +(0,-5) .. (coord_target);
\end{tikzpicture}
\end{document}
